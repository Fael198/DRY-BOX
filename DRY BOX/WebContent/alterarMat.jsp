...
<title>Alterar dados de Material</title>
</head>
<body onload="menu()">
	...
	<div id='bordaConteudo'>
		<div id='titulo'>Alterar dados de Material</div>
		...
		<br />
		<button onclick='alterarMaterial()' id="alterarMat" type="submit">ALTERAR</button>
	</div>

		...
		<form action="DB_srv" method="post">
		    <table id="tabelaCadMaterial" cellspacing="20" cellpadding="1">
		        <tr>
		            ...
		            <td><input type="text" name="partnumber" id="partnumber" size="30" placeholder="Part Number..." required><td>
		        </tr>
		        <tr>
		            <td><label for="quantidade"></label></td>
		            <td><input type="text" name="quantidade" id="quantidade" size="30" placeholder="Quantidade..." required><td>
		        </tr>
		        <tr>
		            <td><label for="localizacao"></label></td>
		            <td><input type="text" name="localizacao" id="localizacao" size="30" placeholder="Localização..." required><td>
		        </tr>
		        <tr>
		            <td><label for="descricao"></label></td>
		            <td><input type="text" name="descricao" id="descricao" size="30" placeholder="Descrição..." required><td>
		        </tr>
		        <tr>
		            <td><label for="quantidadeMin"></label></td>
		            <td><input type="text" name="quantidadeMin" id="quantidadeMin" size="30" placeholder="Quantidade Mínima..." required><td>
		        </tr>
		        <tr>
		            <td><label for="quantidadeMax"></label></td>
		            <td><input type="text" name="quantidadeMax" id="quantidadeMax" size="30" placeholder="Quantidade Máxima..." required><td>
		        </tr>
		    </table>
		</form>
